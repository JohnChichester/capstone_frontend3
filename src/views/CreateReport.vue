  ...
  <div class="csidebar-mini sidebar-closed sidebar-collapse" style="height: auto">
    ...
    <div class="card card-secondary">
      <div class="card-header">
        <h3 class="card-title">EOD Report</h3>
      </div>
      <div class="card-body">
        <form v-on:submit.prevent="submit()">
          <div class="input-group mb-3">
            <div class="input-group-prepend">
              <button type="button" class="btn btn-success">How was Your Day?</button>
            </div>
            <!-- /btn-group -->
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Sustain</h3>
              <div class="card-tools">
                <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                  <i class="fas fa-minus"></i>
                </button>
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Set in order</h3>
              <div class="card-tools">
                <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                  <i class="fas fa-minus"></i>
                </button>
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Standardize</h3>
              <div class="card-tools">
                <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                  <i class="fas fa-minus"></i>
                </button>
